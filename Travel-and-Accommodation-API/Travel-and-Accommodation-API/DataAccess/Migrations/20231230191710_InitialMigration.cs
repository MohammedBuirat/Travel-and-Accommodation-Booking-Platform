        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfRatings = table.Column<int>(type: "int", nullable: false),
                    ...
                    CreationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ModificationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DistanceFromCityCenter = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfReview = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    SecurityRating = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateOfView = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLastHotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLastHotels_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserLastHotels_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                name: "CartBookingRooms",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CartBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartBookingRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartBookingRooms_CartBookings_CartBookingId",
                        column: x => x.CartBookingId,
                        principalTable: "CartBookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartBookingRooms_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomDays_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartBookingRooms_CartBookingId",
                table: "CartBookingRooms",
                column: "CartBookingId");

            migrationBuilder.CreateIndex(
                name: "IX_CartBookingRooms_RoomId",
                table: "CartBookingRooms",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLastHotels_HotelId",
                table: "UserLastHotels",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLastHotels_UserId",
                table: "UserLastHotels",
                column: "UserId");
        }
